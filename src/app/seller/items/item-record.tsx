...
export default function ItemRecord(props: {item: Item}) {
  return <div className="record text-center">
      <span className="flex-grow record-item text-left capitalize">{props.item.name}</span>
      <span className="w-40 text-center record-item font-number">{props.item.price}</span>
